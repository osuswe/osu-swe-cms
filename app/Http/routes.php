...
Route::post("/admin/update/profile", ['middleware' => 'cors', function (\Illuminate\Http\Request $r) {
    $userC = new UsersController();
    echo $userC->update_user($r);
}]);

Route::get('/admin/get/users', ['middleware' => 'cors', function () {
    $userC = new UsersController();
    echo $userC->getUsers();
}]);

Route::get('/admin/get/links', ['middleware' => 'cors', function () {
